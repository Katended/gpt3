...
}, "The Future is Now and You Just Need to Realize It. Step into Future Today. & Make it Happen.")), /*#__PURE__*/React.createElement("div", {
  className: "gpt3__features-container"
}, featuresData.map(item => /*#__PURE__*/React.createElement(Feature, {
  title: item.title,
  text: item.text,
  key: uuidv4()
}))));
